...
let matter;
try { ({ default: matter } = await import("gray-matter")); }
catch (e) { console.error("❌ gray-matter не установлен"); process.exit(2); }
...
async function ensureDir(dir){ try{ await mkdir(dir, { recursive:true }); }catch{} }
...
const toDate = d => { try{ return new Date(d).getTime()||0; }catch{ return 0; } };
